    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    @guest
                        <li><a href="{{route('home.show')}}" class="nav-link scrollto active"><i class="bx bx-home"></i> <span>Login</span></a></li>
                    @endguest
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center ">
        <div class="hero-container" data-aos="fade-in">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="placeholder" aria-label="Recipient's username" aria-describedby="basic-addon2">
